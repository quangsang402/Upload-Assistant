config = {
    ...
    "TRACKERS": {
        ...
        # Available tracker: ACM, AITHER, AL, ANT, AR, ASC, AZ, BHD, BHDTV, BJS, BLU, BT, CBR, CZ, DC, DP, EMUW, FF, FL, FNP, FRIKI, GPW, HDB, HDS, HDT, HHD, HUNO, IS, ITT, IHD, LCD, LDU, LST, LT, MTV, NBL, OE, OTW, PHD, PT, PTER, PTP, PTS, PTT, R4E, RAS, RF, RTF, SAM, SHRI, SN, SP, SPD, STC, THR, TIK, TL, TTG, TTR, TVC, ULCX, UTP, YOINK, YUS
        ...
        "IHD": {
            ...
            "api_key": "",
            "anon": False,
            # Send uploads to IHD modq for staff approval
            "modq": False,
            # Send uploads to IHD drafts
            "draft": False,
        },
        "LCD": {
            # Instead of using the tracker acronym for folder name when sym/hard linking, you can use a custom name
